      ...
      <center>
        <div class="col-md-8 col-lg-6 col-sm-10 shadow-lg" style="background: white;padding-top: 5rem; padding-bottom: 5rem; border-radius: 1rem;">
          ...
          <div class="" style="height: auto; padding-top: 5rem;">
              <a class="del_btn" href="teacher_delete_2.php?delete_id=<?php echo $id; ?>&nic=<?php echo $nic; ?>">Yes,Delete it!</a>
              <a class="del_btn" href="teacher.php" style="background: blue;">Cancel</a>
          </div>
        </div>
      </center>
    </div>
