        ...
        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
          <div class="p-4" style="width: 100%; background: white; height: auto; margin-top: 0rem;">
            <?php 
              ...
              $sql = "SELECT * FROM tbl_class where stream = 1";
              $result = $conn->query($sql);
            ?>
            <center>
              <div class="dataTables_wrapper" style="width: 99%; font-size: 1.5rem"> 
                <h1 class="mb-5" style="font-size: 30px;">Classes | 6-9</h1>
                <center>
                  <a href="class_edit.php?action=add" style="background: #f1d6d6; color: black; text-decoration: none; padding: 10px; border-radius: 10px;"><i class="fas fa-user-plus"></i> Add Class</a>
                </center>
                ...
                <?php if ($result->num_rows > 0) { ?>
                  <table id="table1" class="display" style="padding: 1rem;">
                    ...
                    <?php while($row = $result->fetch_assoc()) { 
                      ...
                      <tr>
                        <td style="background: white;"><?php echo $row['class'] ?></td>
                        <td>
                          <center>
                            <a href="class_edit.php?action=update&update_id=<?php echo $row['class_id'] ?>"><i class="fas fa-user-edit pr-3 pl-3"></i></a>
                            <a style="color: red;" href="class_edit.php?action=delete&delete_id=<?php echo $row['class_id'] ?>"><i class="fas fa-trash"></i></a>
                          </center>
                        </td>
                      </tr>
        ...
        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
          <div class="p-4" style="width: 100%; background: white; height: auto; margin-top: 0rem;">
            <?php 
              ...
              $sql = "SELECT * FROM tbl_class where stream = 2";
              $result = $conn->query($sql);
            ?>
            <center>
              <div class="dataTables_wrapper" style="width: 99%; font-size: 1.5rem"> 
                <h1 class="mb-5" style="font-size: 30px;">Classes | O/L</h1>
                <center>
                  <a href="class_edit.php?action=add" style="background: #f1d6d6; color: black; text-decoration: none; padding: 10px; border-radius: 10px;"><i class="fas fa-user-plus"></i> Add Class</a>
                </center>
        ...
        <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
          <div class="p-4" style="width: 100%; background: white; height: auto; margin-top: 0rem;">
            <?php 
              ...
              $sql = "SELECT * FROM tbl_class where stream = 3";
              $result = $conn->query($sql);
            ?>
            <center>
              <div class="dataTables_wrapper" style="width: 99%; font-size: 1.5rem"> 
                <h1 class="mb-5" style="font-size: 30px;">Classes | A/L</h1>
                <center>
                  <a href="class_edit.php?action=add" style="background: #f1d6d6; color: black; text-decoration: none; padding: 10px; border-radius: 10px;"><i class="fas fa-user-plus"></i> Add Class</a>
                </center>
