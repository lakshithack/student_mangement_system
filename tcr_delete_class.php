      ...
      <center>
        <div class="col-md-8 col-lg-6 col-sm-10 shadow-lg" style="background: white;padding-top: 5rem; padding-bottom: 5rem; border-radius: 1rem;">
          ...
          <div class="" style="height: auto; padding-top: 5rem;">
              <a class="del_btn" href="tcr_delete_class_2.php?delete_id=<?php echo $delete_id; ?>&sub_id=<?php echo $sub_id; ?>&class_id=<?php echo $class_id; ?>">Yes,Delete it!</a>
              <a class="del_btn" href="tcr_my_classes.php" style="background: blue;">Cancel</a>
          </div>
        </div>
      </center>
