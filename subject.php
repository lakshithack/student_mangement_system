        ...
        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
          <div class="p-4" style="width: 100%; background: white; height: auto; margin-top: 0rem;">
            <?php 
              ...
              $sql = "SELECT tbl_subject.* from tbl_subject where stream = 1";
              $result = $conn->query($sql);
            ?>
            <center>
              <div class="dataTables_wrapper" style="width: 60%; font-size: 1.5rem"> 
                <h1 class="mb-5" style="font-size: 30px;">Subjects | 6-9</h1>
                <center>
                  <a href="subject_edit.php?action=add" style="background: #f1d6d6; color: black; text-decoration: none; padding: 10px; border-radius: 10px;"><i class="fas fa-user-plus"></i> Add Subject</a>
                </center>
                  ...
                  <table id="table1" class="display" style="padding: 1rem;">
                    ...
                    <?php 
                      ...
                      <tr>
                        ...
                        <td>
                          <center>  
                            <a href="student_update.php?update_id=<?php echo $row['sub_id'] ?>"><i class="fas fa-user-edit pr-3 pl-3"></i></a>
                            <a style="color: red;" href="student_delete.php?delete_id=<?php echo $row['sub_id'] ?>"><i class="fas fa-trash"></i></a>
                          </center>
                        </td>
                      </tr>
        ...
        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
          <div class="p-4" style="width: 100%; background: white; height: auto; margin-top: 0rem;">
            <?php 
              ...
              $sql = "SELECT tbl_subject.* from tbl_subject where stream = 2";
              $result = $conn->query($sql);
            ?>
            <center>
              <div class="dataTables_wrapper" style="width: 60%; font-size: 1.5rem"> 
                <h1 class="mb-5" style="font-size: 30px;">Subjects | O/L</h1>
                <center>
                  <a href="subject_edit.php?action=add" style="background: #f1d6d6; color: black; text-decoration: none; padding: 10px; border-radius: 10px;"><i class="fas fa-user-plus"></i> Add Subject</a>
                </center>
        ...
        <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
          <div class="p-4" style="width: 100%; background: white; height: auto; margin-top: 0rem;">
            <?php 
              ...
              $sql = "SELECT tbl_subject.* from tbl_subject where stream = 3";
              $result = $conn->query($sql);
            ?>
            <center>
              <div class="dataTables_wrapper" style="width: 60%; font-size: 1.5rem"> 
                <h1 class="mb-5" style="font-size: 30px;">Subjects | A/L</h1>
                <center>
                  <a href="subject_edit.php?action=add" style="background: #f1d6d6; color: black; text-decoration: none; padding: 10px; border-radius: 10px;"><i class="fas fa-user-plus"></i> Add Subject</a>
                </center>
